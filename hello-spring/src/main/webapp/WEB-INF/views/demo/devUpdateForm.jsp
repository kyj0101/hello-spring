...
<div id="demo-container" class="mx-auto">
	...
	<form id="devFrm"
		...
		<div class="form-group row">
		  <input type="hidden" value="${dev.no}" name="no" />
	    ...
	    <div class="form-group row">
	    	...
	    	<div class="col-sm-10">
				...
				<div class="form-check form-check-inline">
				  <input class="form-check-input" type="radio" name="gender"
				  		id="gender1" value="F"  ${dev.gender == 'F' ? 'checked' : ''}>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				<div class="form-check form-check-inline">
				  <input class="form-check-input langchk" type="checkbox" name="lang" id="Java" value="Java" ${langList.contains('Java') ? 'checked' : '' }>
				  <label class="form-check-label" for="Java">Java</label>
				</div>
				<div class="form-check form-check-inline">
				  <input class="form-check-input langchk" type="checkbox" name="lang" id="C" value="C" ${langList.contains('C') ? 'checked' : '' }>
				  <label class="form-check-label" for="C">C</label>
				</div>
				<div class="form-check form-check-inline">
				  <input class="form-check-input langchk" type="checkbox" name="lang" id="Javascript" value="Javascript"  ${langList.contains('Javascript') ? 'checked' : '' }>
...
$(function(){
	$("#devFrm").submit((e) => {
		...
		console.log($(".langchk:checked").length);
		...
		}else if($(".langchk:checked").length == 0){
			alert("다시입력하세욘");
			return false;
		}
