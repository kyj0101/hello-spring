...
<div id="demo-container" 
	...
	<div class="list-group">
	  <button type="button" onclick="devSubmit('dev1');" class="list-group-item list-group-item-action">파라미터 핸들링 - HttpServletRequest</button>
	  <button type="button" onclick="devSubmit('dev2');" class="list-group-item list-group-item-action">파라미터 핸들링 - @RequestParam</button>
	  <button type="button" onclick="devSubmit('dev3');" class="list-group-item list-group-item-action">파라미터 핸들링 - command객체</button>
	  <button type="button" onclick="devSubmit('insertDev');" class="list-group-item list-group-item-action">DB insert</button>
	</div>
</div>
<script>
/**
 * Template String
   jsp사용시 escpaing  처리 필수
 */
