...
<script>
$(function(){
var isoStr = new Date('<fmt:formatDate pattern="yyyy-MM-dd'T'HH:mm:ss" value="${board.regDate}"/>').toISOString();
$('input[name="regDate"]').val(isoStr.substring(0,isoStr.length-1));
});
